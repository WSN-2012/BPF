...
public class DTNSend extends Activity {
	...
	private void initUI() {
		DestEIDEditText = (EditText) this
				.findViewById(R.id.DTNApps_DTNSend_DestEIDEditText);
		MessageTextView = (TextView) this
				.findViewById(R.id.DTNApps_DTNSend_MessageTextView);
		SendButton = (Button) this
				.findViewById(R.id.DTNApps_DTNSend_SendButton);
		SendButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					new AlertDialog.Builder(DTNSend.this)
							.setMessage(
		...
		closeButton = (Button) this
				.findViewById(R.id.DTNApps_DTNSend_CloseButton);
	...
	private void checkInputEID() throws InvalidEndpointIDException {
		String dest_eid = DestEIDEditText.getText().toString();
		if (!EndpointID.is_valid_URI(dest_eid))
