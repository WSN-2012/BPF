...
public class DTNApps extends Activity {
	 ...
	 * Add by Hao
	 */
	private Button DTNEmailOpenButton;
	/** End by hao ***/

	private Button CloseButton;

	/**
	 * Oncreate overriding of Android Activity. Basically, this call DTNApps
	 * layout from Android Layout and then init() function of this class
	 */
	...
	/**
	 * Initialiazing function for DTNApps. Bind the object to runtime button,
	 * add event listeners
	 */
	private void init() {
		DTNSendOpenButton = (Button) this
				.findViewById(R.id.DTNApps_DTNSendOpenButton);
		DTNReceiveOpenButton = (Button) this
				.findViewById(R.id.DTNApps_DTNReceiveOpenButton);

		/*
		 * Add by hao
		 */
		DTNEmailOpenButton = (Button) this
				.findViewById(R.id.DTNApps_DTNEmailOpenButton);
		/* end Add by Hao */
		...
		/* add by hao */
		DTNEmailOpenButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent i = new Intent(DTNApps.this, DTNEmail.class);
				startActivity(i);
			}
		});
		/* end add by hao */
