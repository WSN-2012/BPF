...
public class BufferHelper {
	...
	public static void copy_data( IByteBuffer dest, int dest_offset, IByteBuffer src, int src_offset, int len)
	{
		...
		try
		{
			...
			Logger.getInstance().debug("BufferHelper", "src p: "+src.position()+" len: "+len+" : src"+src.capacity());
			Logger.getInstance().debug("BufferHelper", "des p: "+dest.position()+" len: "+len+" : src"+dest.capacity());			
			src.get(temp);
