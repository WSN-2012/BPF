 ...
 * seconds from 1 Jan, 2000 and the nanoseconds from that second. Because of the
 * limitation of Java to retrieve nanoseconds value, it's always zero here.
 * 
...
public class DTNTime implements Serializable {
	 ...
	 * 
	 * @param seconds
	 *            Time in seconds to init DTNTime
	 * @param nanoseconds
	 *            Time in nanoseconds to init DTNTime
	 */
	...
	/**
	 * Construct the BundleTimestamp based on the inputTime Date and the seqno
	 * specified
	 * 
	 * @param inputTime
	 *            Date object, get seconds from date and init DTNTime
	 */
	 ...
	 * 
	 * @param dt
	 *            DTNTime object to get the length of SDNV encoding of the input
	 *            DTNTime
	 * @return Total length of SDVN encoding of DTNTime
	 */
	public static int SDNV_encoding_len(DTNTime dt) {
		return SDNV.encoding_len(dt.seconds_)
				+ SDNV.encoding_len(dt.nanoseconds_);
	}
	 ...
	 *            DTNTime to encode
	 * @param buf
	 *            Serializable Buffer to store SDNV of DTNTime
	 */
	 ...
	 * 
	 * @param dt
	 *            Empty DTNTime to store decoded DTNTime
	 * @param buf
	 *            Serializable Buffer to read and recode DTNTime
	 */
	 ...
	 * 
	 * @param seconds_pass_from_ref
	 *            Set seconds
	 * @param nano_seconds_pass_from_the_second
	 *            Set Nanoseconds
	 */
	private void init(long seconds_pass_from_ref,
			long nano_seconds_pass_from_the_second) {
	...
	/**
	 * IsEqual operation. The DTNTime will be equal iff both the seconds and
	 * nanoseconds are equal
	 * 
	 * @param other
	 *            DTNTime to compare with current DTNTime
	...
	/**
	 * isLessThan operation. Use seconds to compare and nanoseconds to break
	 * tie.
	 * 
	 * @param other
	 *            DTNTime to compare with current DTNTime
	...
	/**
	 * isGreaterThan operation. Use seconds to compare and nanoseconds to break
	 * tie.
	 * 
	 * @param other
	 *            DTNTime to compare with current DTNTime
