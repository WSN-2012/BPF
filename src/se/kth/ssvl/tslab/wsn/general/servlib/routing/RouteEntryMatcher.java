...
public class RouteEntryMatcher {
	/**
	 * matching type enum. There are two matching types including
	 * EndpointIDPattern Matching and Link Matching
	 * 
	 * @author Rerngvit Yanggratoke (rerngvit@kth.se)
	 */
	public static enum match_type_t {
		EndpointIdPatternMatching, LinkMatching
	}
	...
	/**
	 * Constructor for the matcher to match with the Destination
	 * EndpointIDPattern
	 * 
	 * @param dest_pattern
	 *            The EndpointIDPattern to be matched
	 */
	 ...
	 * 
	 * @param entry
	 *            the input RouteEntry to test
	 * @return the result of matching
	 */
	public boolean match(RouteEntry entry) {
		if (match_type_ == match_type_t.EndpointIdPatternMatching
				&& entry.route_to() != null)
