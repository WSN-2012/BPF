 ...
 * depending on the naming scheme used.
 * 
...
public class EndpointID implements Serializable {
	 ...
	 * 
	 * @param uri
	 *            an absolute URI representation for this new EndpointID
	 */
	 ...
	 * 
	 * @param other
	 *            The source EndpointID to create from
	 */
	 ...
	 * 
	 * @param other
	 *            The source EndpointID to assign the value from
	 * @return whether the assign is successful ( it's not an invalid URI, for
	 *         example )
	 */
	...
	/**
	 * Assign EndpointID based on ByteBuffer contents and length The position of
	 * the input buffer will not change from this method
	 * 
	 * 
	 */
	 ...
	 * 
	 * @param str
	 *            The source String to assign to this EndpointID
	 ...
	 * 
	 * @param scheme
	 *            The input scheme to be set to this EndpointID
	 * @param ssp
	 *            The input schedme specific part to be set to this EndpointID
	 * @return true if the string is a valid id, false if not.
	 */
	...
	/**
	 * Override from equals of object to check whether the EndpointID is the
	 * same or not This basically checks the URI of both the EndpointID
	 * 
	...
	/**
	 * function to check whether this EndpointID is considered Null or not It
	 * will be either the URI is null, it's equal to NULL EndpoindID( this
	 * depends on the naming Scheme, for example, in DTN Scheme, it is
	 * "dtn:none" ), or the EndpointID String is ""
	 * 
	...
	/**
	 * function to check whether the given EndpointID is contained within this
	 * EndpointID; otherwise false.
	 * 
	 * @param other
	 *            The input EndpointID to check whether it is subsumed or not
	...
	public boolean append_service_wildcard() {
		...
		if (uri_.equals(DTNScheme.NULL_EID().toString()))
			return false;
	...
	/**
	 * Return the special endpoint id used for the null endpoint, namely Support
	 * only DTN Scheme for now "dtn:none".
	 */
	...
	/**
	 * Getter function for whether this EndpointID is an instance of
	 * EndpointIDPattern
	 * 
	...
	/**
	 * Internal function to validate URI. This function is used by other
	 * operations to validate the URI
	 * 
