        ...
        try{
	        ...
	        for (iter = fragments_.begin(); !iter.equals(fragments_.end()) ; ++fragi)
	        {
	            ...
	            if (f_origlen != total_len) {
	            	...
	            	Logger.getInstance().error("FragmentState", String.format("check_completed: error fragment orig len %d != total %d",
	                        f_origlen, total_len));
	            ...
	            if (done_up_to == f_offset) {
	                 ...
	                 *           fff
	                 */
	                Logger.getInstance().debug(TAG, String.format("check_completed fragment %d/%d: "
            ...
            if (done_up_to == total_len) {
                Logger.getInstance().debug(TAG, "check_completed reassembly complete!");
                return true;
            } else {
                Logger.getInstance().debug(TAG, String.format("check_completed reassembly not done (got %d/%d)",
