 ...
 */
/**
 * This class is implemented as Singleton to Registration. This class generates
 * registration id, stores registration on the disk . This class also uses
 * Generic StorageImplementation and SQLiteImplementation to store registration.
 * 
...
public class RegistrationStore {
	 ...
	 */
	private static final String Table_CREATE_Registration = "create table IF NOT EXISTS  registration (id integer primary key autoincrement, "
			+ " uri text);";
	 ...
	 * This function creates StorageImplementation & SQLiteImplementation
	 * instances, set storage directory path & counts valid number of
	 * registrations.
	 * 
	 * @param context
	...
	/**
	 * Get the registration from storage based on regid and return the
	 * registration.
	 * 
	 * @param regid
	 *            Get the registration with this regid from storage
	 * @return If registration found then return the bundle otherwise return
	 *         null
	 */
	 ...
	 * 
	 * @return RegistrationList Populated Registration list with all the
	 *         registrations
	 */
	public RegistrationList load() {
		...
		String condition = " id > " + Registration.MAX_RESERVED_REGID;
		String field = "id";
		List<Integer> regids = impt_sqlite_
				.get_records(table, condition, field);
	...
	/**
	 * Reset all the registration storage. It resets registration storage folder
	 * and registration table in database.
	 * 
	 ...
	 * 
	 * @param reg
	 *            Registration to check if already stored or not.
	...
	private static class RegistrationStoreIterator implements
		 ...
		 * @param registration_store
		 *            to access registration_store objects
		 * @param table
		 *            database table name
		 * @param pre_condition
		...
		public void set_itr(SQLiteImplementation impt_sqlite,
			...
			itr_ = new StorageIterator<Registration>(impt_sqlite, table,
