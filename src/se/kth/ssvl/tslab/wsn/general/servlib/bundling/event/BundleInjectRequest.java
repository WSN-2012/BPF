 ...
 * want to inject the Bundle can do so by posting this event to the
 * BundleDaemon.
 * 
...
public class BundleInjectRequest extends BundleEvent {
	...
	/**
	 * Accessor for the Priority for this Bundle Delivery according to the
	 * Protocol
	 * 
	...
	/**
	 * Setter for the Priority for this Bundle Delivery according to the
	 * Protocol
	 * 
	 * @param priority
	...
	/**
	 * Accessor for the unique identifier of this BundleInjectRequest. This will
	 * be used to refer later including in BundleInjectedRequest
	 * 
	...
	/**
	 * Setter for the unique identifier of this BundleInjectRequest. This will
	 * be used to refer later including in BundleInjectedRequest
	 * 
	 * @param requestId
