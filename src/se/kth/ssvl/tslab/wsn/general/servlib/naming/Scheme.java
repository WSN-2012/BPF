...
public abstract class Scheme {
	 ...
	 * If the 'is_pattern' paraemeter is true, then the ssp is being validated
	 * as an EndpointIDPattern.
	 * 
	 ...
	 */
	public abstract boolean match(final EndpointIDPattern pattern,
			final EndpointID eid);
	 ...
	 *         wildcard is successfully appended, else exception will be null
	 *         will be returned.
	 ...
	 * not capable of this.
	 * 
	 * @return URI result objected if this scheme is capable of this reduction
	 *         and the reduction is successful, else null object will be
	 *         returned.
	 */
